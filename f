--[[
Remade for Facts#3866 by Oopss-Sorry#2067
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.KeySystem then
		...
		if not isfile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			writefile(RayfieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension)
		end
		...
		if not Passthrough then            
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				pcall(function()
					if KeyMain.Input.InputBox.Text == game:HttpGet("https://1.kelprepl.repl.co/verify/FactsHub?verify_key="..KeyMain.Input.InputBox.Text) or KeyMain.Input.InputBox.Text == "SUg7brH2XL6uE86JaYjne49Z2tyM36j9" then
